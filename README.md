...
The Qirab™ Macro Slider is a precision camera macro tool with 0.5mm precision. It is made from 3D printed parts, 20x20 aluminum profile and a T8 lead screw.
...
QMS v1.3.1 on QTC50 CAD


The slider currently uses the <a href="https://www.manfrotto.com/global-en/quick-change-rectangular-plate-adapter-universal-threads-323/">Manfroto RC2 Quick Change Rectangular Plate Adapter</a>. It could be modified to work with other camera plates or systems. 

![QMS v1.3.1 exploded view](https://github.com/Qirab/QirabMacroSlider/blob/156b448aab1878674a392b52049280672d6f4ee1/QMSv1.3.1_explodedview.png?raw=true)
QMS v1.3.1 exploded view
